...
class BitPack:
	...
	################################################
	@staticmethod
	def pack_8bit_u8(W_q: Tensor):
		return W_q.to(uint8)

	@staticmethod
	def unpack_8bit_u8(W_q: Tensor):
		return W_q
	...
	def unpack_2bit_u8_cat(W_q: Tensor):
		return torch.cat([
            (W_q & 0b11000000) >> 6, (W_q & 0b00110000) >> 4, (W_q & 0b00001100) >> 2, W_q & 0b00000011
        ], axis=0)
	...
	################################################################################################################
	@staticmethod
	def pack_3bit2bit_u8(W_q: Tensor):
	...
	@staticmethod
	def unpack_3bit2bit_u8(W_q: Tensor):
		return torch.cat([
            (W_q & 0b11100000) >> 6, (W_q & 0b00011100) >> 3, W_q & 0b00000011
        ], axis=0)
